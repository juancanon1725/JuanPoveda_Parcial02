...
public class CvdsLab7Application {
	...
	public CommandLineRunner run() throws Exception {
		return (args) -> {
			...
			employeeService.addEmployee(new Employee("Hank", "Hill", "Salesman", 63000.00, new Date(20, 7, 1994)));
			employeeService.addEmployee(new Employee("Peggy", "Hill", "Substitute", 43000.00, new Date(30, 2, 1983)));
			employeeService.addEmployee(new Employee("Homer", "Simpson", "Plant Operator", 163000.00, new Date(16, 6, 1982)));
			employeeService.addEmployee(new Employee("Rick", "Sanchez", "Scientis", 633000.00, new Date(10, 8, 1989)));
			employeeService.addEmployee(new Employee("Bob", "Belcher", "Fry Cook", 10.00, new Date(18, 4, 1975)));
